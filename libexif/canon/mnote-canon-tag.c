...
static struct {
	...
	{MNOTE_CANON_TAG_SETTINGS_1,  1, N_("Self time")},
	{MNOTE_CANON_TAG_SETTINGS_1,  2, N_("Quality")},
	{MNOTE_CANON_TAG_SETTINGS_1,  3, N_("Flash mode")},
	{MNOTE_CANON_TAG_SETTINGS_1,  4, N_("Continuous drive mode")},
	...
	{MNOTE_CANON_TAG_SETTINGS_1, 17, N_("Focus type")},
	{MNOTE_CANON_TAG_SETTINGS_1, 18, N_("AF point selected")},
	...
	{MNOTE_CANON_TAG_SETTINGS_1, 35, N_("Zoomed resolution")},
	{MNOTE_CANON_TAG_SETTINGS_1, 36, N_("Zoomed resolution base")},
	...
	{MNOTE_CANON_TAG_SETTINGS_2, 13, N_("AF point used")},
	{MNOTE_CANON_TAG_SETTINGS_2, 14, N_("Flash bias")},
	{MNOTE_CANON_TAG_SETTINGS_2, 18, N_("Subject distance")},
	{0, 0, NULL}
};
